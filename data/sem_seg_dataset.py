...
from model.llava.constants import (ANSWER_LIST, ANSWER_LIST_MODE4_END,
                    ANSWER_LIST_MODE4_START, ANSWER_LIST_MODE4_TEMPLATE, SHORT_QUESTION_LIST_MODE4)
...
def init_ade20k(base_image_dir):
    with open("data/literals/ade20k_classes.json", "r") as f:
...
def init_cocostuff(base_image_dir):
    cocostuff_classes = []
    with open("data/literals/cocostuff_classes.txt") as f:
